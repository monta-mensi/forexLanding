                  ...
                  <div className="feature__content-inner">
                    <div className="section-header">
                      ...
                      <p className="mb-0">
                        ...
                        amazing and top-notch features.
                      </p>
                    </div>

                    <div className="feature__nav">
  <Nav variant="pills" className="nav--feature featresItem">
    {featureData.map((item, index) => (
      <div key={index} className="feature__item-wrapper" style={{ display: 'block', marginBottom: '10px' }}>
